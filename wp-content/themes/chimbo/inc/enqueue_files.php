...
function chimboChild_styles() {
	wp_enqueue_style( 'google_font', '<link href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Libre+Franklin:ital,wght@0,100;0,800;1,800&display=swap" rel="stylesheet">
	');
